...
<head>
  ...
  <style>
    body { font-family: "Sarabun", sans-serif; padding: 2rem; max-width: 900px; margin: 0 auto; }
    :root { --heading-h1:1.5em;--heading-h2:1.3em;--heading-h3:1.15em;--heading-h4:1.05em;--heading-h5:.95em;--heading-h6:.9em; }
    h1{font-size:var(--heading-h1)}h2{font-size:var(--heading-h2)}h3{font-size:var(--heading-h3)}
    h4{font-size:var(--heading-h4)}h5{font-size:var(--heading-h5)}h6{font-size:var(--heading-h6)}
    .katex-display{margin:1em 0;padding:.5em 0;overflow-x:auto;overflow-y:hidden}
    .katex-inline{padding:0 .2em}
    li:has(input[type="checkbox"]){list-style-type:none;padding-left:0}
  </style>
</head>
